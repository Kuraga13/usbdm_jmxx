...
#[derive(PrimitiveEnum_u8, Clone, Copy, Debug, PartialEq)]
 ...
 impl From<PowerState> for Result<PowerStatus, BdmError> {
   fn from(power_from_bdm : PowerState) -> Result<PowerStatus, BdmError> {
     match power_from_bdm {
            ...
            PowerState::Error        => Err(BdmError::PowerErrorInFeedback),  // Target Vdd error Possible overload !
     }    
   }
 }
...
impl Programmer
{
   ...
   pub fn get_bdm_feedback(&self) -> Result<FeedBack, BdmError>{
